...
import { Flame, Maximize, Info } from 'lucide-react';
...
const SafetyExtrasStep = () => {
  const { state, setFloors, setPropertySize, addToCart, getCartItem, updateQuantity, getCartTotal } = useCalculator();
...
export default SafetyExtrasStep;
