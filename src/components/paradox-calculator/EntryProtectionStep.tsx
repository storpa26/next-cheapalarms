...
const EntryProtectionStep = () => {
  const { state, setHasGarageOrMetalDoors, addToCart, getCartItem, hasSiren } = useCalculator();
  ...
  // Check if repeater is likely needed
...
export default EntryProtectionStep;
