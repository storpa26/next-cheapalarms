...
export default function SquadShowcase() {
  ...
  return (
    <section className="bg-[#F5FBFD] py-20 text-slate-900">
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center">
          <p className="text-sm uppercase tracking-[0.4em] text-[#0AA9AB]">Meet the squad</p>
          <h2 className="mt-2 text-3xl font-semibold text-slate-900">Tap a device pod to see why Percy trusts it.</h2>
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[1.3fr_0.7fr]">
          <div className="grid place-items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {addonCatalog.slice(0, 9).map((addon, idx) => {
              ...
              return (
                ...
                >
                  <div className="flex h-full w-full flex-col items-center justify-center rounded-full bg-white/80">
                    <div className="relative h-20 w-20 overflow-hidden rounded-full border border-white/20 shadow-inner">
                      <Image
          ...
          <div className="relative overflow-hidden rounded-[32px] border border-[#DCECEF] bg-white p-6 shadow-[0_35px_80px_-45px_rgba(5,35,52,0.2)]">
            {activeAddon ? (
              <>
                ...
                <div className="mt-4 grid gap-4 text-sm text-white/80">
                  {activeAddon.details?.doINeedThis ? (
                    <div className="rounded-2xl bg-[#F2FEFE] p-4 text-slate-700">
                  ...
                  {activeAddon.details?.bestFor ? (
                    <div className="rounded-2xl bg-[#F8FBFF] p-4 text-slate-700">
                ...
                <Link
                  ...
                  className="mt-6 inline-flex items-center justify-center rounded-full px-5 py-3 text-sm font-semibold text-white shadow-lg"
              ...
              <div className="flex h-full flex-col items-center justify-center text-center text-slate-600">
                ...
                <p className="mt-3 text-base font-semibold text-slate-900">Tap a pod to see its story.</p>
              </div>
            )}
