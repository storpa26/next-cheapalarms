...
export function SkipSection({ 
  ...
  return (
    <div className="animate-in fade-in duration-300">
      <div className="bg-orange-50 rounded-xl p-4 mb-4 flex gap-3 items-start">
      ...
      <textarea 
        ...
        className="w-full p-3 bg-white border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary transition-all resize-none h-32 mb-4"
      />
