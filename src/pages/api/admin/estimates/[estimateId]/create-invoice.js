...
/**
 * Next.js API route that proxies create invoice from estimate requests to WordPress.
...
export default createWpProxyHandler((req) => {
  ...
  return `/ca/v1/admin/estimates/${encodeURIComponent(estimateId)}/create-invoice`;
}, {
  allowedMethods: ["POST"],
});
